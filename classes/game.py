...
class Person:
    ...
    def choose_action(self):
        ...
        print(Colors.BLUE + Colors.BOLD + "ACTIONS:" + Colors.ENDC)
    ...
    def choose_magic(self):
        i = 1
        print("\n" + Colors.BLUE + Colors.BOLD + "MAGIC:" + Colors.ENDC)
    ...
    def get_stats(self):
        ...
        print(Colors.BOLD + self.name + "    " +
              current_hp + " |" + Colors.GREEN + hp_bar + Colors.ENDC + "|    " +
              current_mp + " |" + Colors.BLUE + mp_bar + Colors.ENDC + "|")
